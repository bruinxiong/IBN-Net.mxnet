...
import mxnet as mx
from symbol_resnet_ibn_a import resnet

logger = logging.getLogger()
logger.setLevel(logging.INFO)

#$hdlr = logging.FileHandler('./log/log-resnet-mem.log')

#hdlr = logging.FileHandler('./log/log-resnet-{}.log'.format(args.data_type))
