...
import mxnet as mx
from symbol_resnext_ibn_a import resnext
...
def main():
    ...
    if not os.path.exists("./model"):
        os.mkdir("./model")
    model_prefix = "model/resnext-ibn-a-{}-{}-{}".format(args.data_type, args.depth, kv.rank)
...
if __name__ == "__main__":
    ...
    hdlr = logging.FileHandler('./log/log-resnext-ibn-a-{}-{}-{}.log'.format(args.data_type, args.depth, 0))
